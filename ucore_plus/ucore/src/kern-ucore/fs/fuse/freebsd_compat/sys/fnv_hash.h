 ...
 * $FreeBSD$
 */
#ifndef _FREEBSD_COMPAT_FNV_HASH_H_
#define	_FREEBSD_COMPAT_FNV_HASH_H_
...
{
	const uint8_t *s = (const uint8_t *)str;
	uregister_t c;		 /* 32 bit on i386, 64 bit on alpha,ia64 */
...
#endif /* _FREEBSD_COMPAT_FNV_HASH_H_ */
