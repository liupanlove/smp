...
struct cpu {
  ...
  struct segdesc gdt[6];   // x86 global descriptor table   // you wen ti
  volatile uint32_t started;       // Has the CPU started?
  int ncli;                    // Depth of pushcli nesting.
  int intena;                  // Were interrupts enabled before pushcli?
  struct proc_struct *proc;           // The process running on this cpu or null
};

extern struct cpu cpus[8];   // magic number.....
extern int ncpu;
