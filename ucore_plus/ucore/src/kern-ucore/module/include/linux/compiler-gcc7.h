//TODO: Linux never has a compiler-gcc7.h. Supporting gcc6 is done by
...
#warning "Compiling modules using gcc7.x, this is not officially supported by Linux 2.6.x modules"
